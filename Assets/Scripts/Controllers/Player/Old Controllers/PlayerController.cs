...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField]
    private FloatScriptableObject playerHealth;
    ...
    public void TakeDamage(float damageAmount)
    {
        ...
        Debug.Log($"{gameObject.name} took {damageAmount} damage. Current health: {playerHealth.Value}");
    }
    ...
    void Update()
    {
        speedModifier = crystalCount.Value / 10;
